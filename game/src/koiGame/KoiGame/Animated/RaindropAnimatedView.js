var RaindropAnimatedView = AnimatedEntityView.extend({
    /** @lends KoiView.prototype */

    ctor:function( preRoll )
    {
        this._super( "res/koiGame/distractors/raindrop/Raindrop", this._createAnimationNames(), null, true );
    ...
    {
        var animations = [];
        animations.push("raindrop_animationsraindrop");
