...
EnterCocos = function(argString){
    cc.log("---EnterCocos--",argString);
    AppEnterFun.onEnter(argString);
};
cc.game.onStart = function(){
    ...
    // cc.view.setDesignResolutionSize(384, 568, cc.ResolutionPolicy.FIXED_HEIGHT);

     // cc.view.setDesignResolutionSize(375, 667, cc.ResolutionPolicy.FIXED_WIDTH);
    ...
    //cc.LoaderScene.preload(g_resources, function () {
        ...
        //if(GameGlobals.getOnDebug()){
            if(cc.sys.platform >= cc.sys.MOBILE_BROWSER){//浏览器
                cc.log("-----AppEnterFun.onEnter();----");
                //AppEnterFun.onEnter();
                AppEnterFun.onEnter.call(AppEnterFun);
                cc.log("-----AppEnterFun.onEnter();----2");
            }
        //}
